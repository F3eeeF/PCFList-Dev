...
export class ShowVehicleDetails implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        const flag = CheckVerificationVIN(VIN);
        const filter = context.parameters.selectionElements?.raw ?? "";
        const API = "";
    ...
    public getOutputs(): IOutputs {
        return { vehicleIdentificationNumber: this._vehicleIdentificationNumber };
    }
